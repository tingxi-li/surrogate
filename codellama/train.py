...
from data_set import get_data_set, get_tokenize_fn, DataCollatorForPromptCompletion
...
parser.add_argument("--output_dir", type=str, default="/opt/dlami/nvme/surrogate_ckpt")
...
if data_format == "completion":
    data_collator = DataCollatorForPromptCompletion(tokenizer)
